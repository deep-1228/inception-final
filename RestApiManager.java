package com.stanzaliving.inception.util;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.stanzaliving.inception.error.CustomRuntimeException;
import com.stanzaliving.inception.error.UnauthorisedException;
...
public abstract class RestApiManager {
    ...
    public <T> T post(String url, Map<String, Object> queryParams, Object body, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType) {
        ...
        if(body instanceof JSONObject || body instanceof JSONArray || body instanceof SearchSourceBuilder){
            httpEntity = new HttpEntity<>(body.toString() , headers);
        }else{
